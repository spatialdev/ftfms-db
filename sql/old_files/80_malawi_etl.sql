...
-- update malawi_updated for null measures
UPDATE malawi_updated
SET measure = 'null'
...
UPDATE malawi_geography
SET admin1 = malawi_temp.adm1_name
FROM malawi_temp
WHERE malawi_geography.admin2= malawi_temp.admin2;
